(() => {
    function startBlockYT() {
      ...
      const startScript = () => {
        ...
        const createBlockAdlock = () => {
          ...
          const create = `
            <svg xmlns="http://www.w3.org/2000/svg" width="56" height="13" viewBox="0 0 56 13" fill="none">
              ...
              <path d="M44.4741 9.4225C44.0666 9.78441 43.5571 9.9912 43.0222 9.9912C41.825 9.9912 40.8444 9.00889 40.8444 7.79393C40.8444 6.57897 41.825 5.58373 43.0222 5.58373C43.6336 5.58373 44.2067 5.84224 44.627 6.29462L44.8562 6.54019L46.3845 5.06673L46.168 4.82115C45.3529 3.94224 44.2194 3.43816 43.035 3.43816C40.6661 3.43816 38.7429 5.38986 38.7429 7.78101C38.7429 10.1722 40.6661 12.1239 43.035 12.1239C44.0666 12.1239 45.06 11.749 45.8496 11.064L46.0916 10.8572L44.7543 9.20277L44.4741 9.4225Z" fill="green"/>
              <path d="M6.13877 0H3.89723L0 12.0204H2.22881L2.95476 9.78433H6.83925L7.50152 12.0204H9.70485L6.13877 0ZM6.20245 7.65169H3.6425L4.97979 3.51564L6.20245 7.65169Z" fill="green"/>
              <path d="M52.4083 6.82443L55.3758 3.36049H52.3701L50.0649 6.06185V-4.57764e-05H47.7852V12.0203H50.0649V9.56456L50.88 8.6081L53.2362 12.0203H55.9999L52.4083 6.82443Z" fill="green"/>
              <path d="M23.2944 9.74551V-4.57764e-05H21.0273V12.0203H28.376V9.74551H23.2944Z" fill="green"/>
              <path d="M17.0029 -4.57764e-05V3.99383C16.3661 3.63192 15.6401 3.43804 14.9014 3.43804C12.5325 3.43804 10.6094 5.38974 10.6094 7.78089C10.6094 10.172 12.5325 12.1237 14.9014 12.1237C15.6401 12.1237 16.3661 11.9299 17.0029 11.568V12.0203H19.2699V-4.57764e-05H17.0029V-4.57764e-05ZM14.9014 9.99109C13.7042 9.99109 12.7363 9.00878 12.7363 7.79381C12.7363 6.57885 13.7042 5.59654 14.9014 5.59654C16.0986 5.59654 17.0665 6.57885 17.0665 7.79381C17.0665 8.99585 16.0986 9.99109 14.9014 9.99109Z" fill="green"/>
        ...
        const objectModification = (obj, propertyName, overrideValue) => {
          if (!obj) {
            return false;
          }
          for (const key in obj) {
            if (obj.hasOwnProperty(key) && key === propertyName) {
              ...
              objectModification(obj[key], propertyName, overrideValue);
            }
          }
        };
  
        const jsonModification = (propertyName, overrideValue) => {
          const nativeJSONParse = JSON.parse;
          JSON.parse = (...args) => {
            const obj = nativeJSONParse.apply(this, args);
            objectModification(obj, propertyName, overrideValue);
            return obj;
          };
          ...
          Response.prototype.json = new Proxy(nativeResponseJson, {
            apply(...args) {
              ...
              return new Promise((resolve, reject) => {
                promise.then((data) => {
                  objectModification(data, propertyName, overrideValue);
                  resolve(data);
